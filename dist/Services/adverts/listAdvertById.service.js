...
const listAdvertByIdService = (advertId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const returnAdvert = adverts_schemas_1.advertSchemaResponseFull.parse(advert);
    return returnAdvert;
});
exports.default = listAdvertByIdService;
